...
canvasGetPixcel.width = 350;
canvasGetPixcel.height = 300;
...
// get minmum lat&lng and maximum lat&lng
...
function initMap() {
  ...
  google.maps.event.addListenerOnce(map, "projection_changed", function () {
    ...
    const boundedWordCloudImage = generateWordCloudImage(cityShapePixelArr, inputWordList);
